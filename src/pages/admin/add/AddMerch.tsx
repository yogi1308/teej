            ...
            <div className="flex flex-col gap-4">
                {imgs.length > 0 ? (
                    ...
                    {imgs.length > 1 && currImgPos !== 0 && 
                        ...
                        {imgs.length > 1 && currImgPos !== imgs.length - 1 && 
                            <div
                    ...
                    <div className="flex-1 content-center text-center text-white/30 border border-dashed border-white cursor-pointer" onClick={() => inputRef.current?.click()}>
                        Upload Images
                    </div>
                )}
                <input
