...
const AddSingles = forwardRef<HTMLFormElement, { songId: number; failed: boolean; onDelete: (id: number) => void }>(
            ...
            <form ref={ref} data-song-id={songId} className={`flex w-full  p-4 gap-8 items-center ${failed ? "border border-red-500" : ""}`}>
                <div className="flex flex-col flex-1 gap-4">
                    ...
                    <input
                        ...
                        required
                    />
                    <button onClick={() => audioRef.current?.click()} type="button" className="border border-dashed border-black py-2 bg-white text-black">
